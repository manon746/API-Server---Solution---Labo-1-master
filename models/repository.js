            ...
            Object.keys(params).forEach(function (paramName) {
                if (paramName == "sort") {
                    ...
                    if (Array.isArray(keyValues)) {
                        ...
                        sortKeys.forEach(key=>filteredAndSortedObjects=objectsList.sort((a, b) => {
                           return  innerCompare(a[key.key],b[key.key]);})
                           )
                           if(sortKeys[0].asc==false){
                            filteredAndSortedObjects.reverse();
                           }
                    ...
                    if (paramName in model)
                        ...
                        searchKeys.forEach(key=>{
                            ...
                            objectsList.forEach(ligne=> 
                                {
                                    if(valueMatch(ligne[key.key],key.value)){
                                        filteredAndSortedObjects.push(ligne)
                                    }
